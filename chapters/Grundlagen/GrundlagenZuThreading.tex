...
\begin{figure}
	...
	\begin{subfigure}[t]{.49\textwidth}
		...
		\begin{tikzpicture}[node distance=1.34cm,on grid, auto]
			...
			;
		\end{tikzpicture}
		\subcaption{Semantisch korrigiertes Unter-Petri-Netz. Die Transition \texttt{end if} besitzt nur die Vorbedingung $p_4$. Somit kann sie feuern nachdem einer der beiden Pfade durchlaufen wurde.}\label{fig:supnetifelse:new}
	\end{subfigure}
