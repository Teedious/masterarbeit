...
\subsubsection{Transitionsregel} Um nun das Verhalten von \glsuserii{Programm} beschreiben zu können, kann die Markierung eines Petri-Netzes anhand der folgenden sogenannten Transitions-Regel geändert werden~\cite{Murata1989}.
\begin{enumerate}
