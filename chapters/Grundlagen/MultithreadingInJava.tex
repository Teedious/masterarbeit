...
\begin{lstlisting}[caption={Beispiel eines Java-\glsuseri{Programm}, das \code{synchronized} zur Synchronisierung nebenläufiger Anweisungen nutzt.}, label={lst:synchronizedExample}]
