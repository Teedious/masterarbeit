...
\begin{lstlisting}[caption={Beispiel eines Java-Programms, das \code{synchronized} zur Synchronisierung nebenläufiger Anweisungen nutzt.}, label={lst:synchronizedExample}]
