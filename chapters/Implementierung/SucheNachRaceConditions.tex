...
\code{DayNightLightig.updateLightPosition(float, boolean)} wird nicht im Render-Thread ausgeführt, sondern während \code{update()} in einem anderen Thread. Der relevante Abschnitt der Methode ist in Listing~\ref{lst:raceLight} dargestellt.
