...
\begin{figure}
	\begin{tikzpicture}
		\node at (0,0) {\includegraphics[width=.32\textwidth]{flackern-1.png}};
		\node[draw=red, circle, minimum size = 1.5cm] at (.25,-.5) {};
	\end{tikzpicture}
	\hfill
	\begin{tikzpicture}
		\node at (0,0) {\includegraphics[width=.32\textwidth]{flackern-2.png}};
		\node[draw=red, circle, minimum size = 1.5cm] at (.25,-.5) {};
	\end{tikzpicture}
	\hfill
	\begin{tikzpicture}
		\node at (0,0) {\includegraphics[width=.32\textwidth]{flackern-3.png}};
		\node[draw=red, circle, minimum size = 1.5cm] at (.25,-.5) {};
	\end{tikzpicture}
...
\begin{figure}
	...
	\caption{Ausschnitt eines Screenshots der Blocklib bei aktivierter \class{ShadowMap}-Anzeige. Die \class{ShadowMap} speichert Entfernungs-Informationen, diese werden als rote Farbe interpretiert und ausgegeben.}\label{fig:ShadowMap}
\end{figure}
