...
Die Durchschnittswerte des stabilen Zustands sind aus den Messungen zwischen Sekunde 25 und 55 ermittelt. Beide Systeme benötigen mit Terrain-Generierung also etwa \SI{5}{\second} länger für den Start. SystemB erreicht nach dem Start eine um \SI{133}{\percent} gesteigerte Framerate gegenüber SystemA. Dieser Wert liegt zwischen den gemessenen Werten der ersten beiden Szenarien.
