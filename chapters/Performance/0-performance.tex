...
Insgesamt werden fünf verschiedene Szenarien betrachtet. In allen Szenarien werden die folgenden Metriken ausgewertet: \si{\fps}, Auslastung der \acs{cpu}, Auslastung der \ac{gpu} und \ac{ram}-Nutzung. In jedem Szenario wird die Blocklib für \SI{60}{\second} ausgeführt. Hierfür ist die durch Java mit der Methode \code{System.currentTimeMillis()} bereitgestellte Zeit ausschlaggebend. Der Code, der für die Ausführung der Szenarien benötigt wird, ist in der Klasse \class{ThreadingProgram} enthalten.
