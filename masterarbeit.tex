...
\subsection{Design der nebenläufigen Architektur}\label{sec:design}
...
\subsection{Etablierung einer Kompositionswurzel}\label{sec:EtablierungEinerKompositionroot}
